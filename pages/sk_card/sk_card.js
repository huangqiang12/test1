...
Page({
  ...
  purchase: function (e) {//购买宿卡按钮
    ...
    // recharge
    var sx_card_id = '';
    if (that.data.card.sx_card > 0) {
      var api_url = '/sxcard/balance_card'//充值
      var sx_card_id = that.data.card.re[0].sx_card_id;
    } else {
      var api_url = '/sxcard/recharge'//购买
    }
