...
Page({
   ...
   */
  data: {
    types:['绑定手机号','设置支付密码','设置支付密码','修改支付密码'],//页面传参值不同选择显示的界面
    msg_code: '获取验证码',
  },
  ...
  sub_password: function (e) {//确定按钮
    ...
    } else if (that.data.types == 1 || that.data.types == 2 || that.data.types == 3 ) {//修改设置密码
      if (that.data.types == 3){//修改密码
        var api_url ='/sxcard/setpaypw_edit';
      }else{//设置密码
        var api_url = '/sxcard/setpaypw';
      }
